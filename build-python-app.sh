...
echo "This is a new ad-hoc app build. Move it to Applications before granting permissions;"
echo "replacing an already-approved Bot Player.app can require approval again."